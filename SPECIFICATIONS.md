# Spécifications — Podium Webradio

**Prise en main rapide** : [docs/README.md](docs/README.md)

Les spécifications détaillées sont dans [`docs/specifications/`](docs/specifications/).

## Index

| Document | Contenu |
|----------|---------|
| [**README**](docs/specifications/README.md) | Vue d'ensemble et index des specs |
| [**Fonctionnel**](docs/specifications/fonctionnel.md) | Contexte, objectifs, périmètre, besoins, critères d'acceptation |
